...
/**
 * @file
 * Contains \Drupal\printable\Form\LinksConfigurationForm.
 */
...
class LinksConfigurationForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $printable_format = NULL) {
    ...
    foreach ($this->config('printable.settings')->get('printable_print_link_locations') as $link_location) {
      $form['settings']['print_print_link_pos']['#default_value'][$link_location] = $link_location;
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    \Drupal::service('config.factory')->getEditable('printable.settings')->set('printable_print_link_locations', $form_state->getValue('print_print_link_pos'))->save();
  }
